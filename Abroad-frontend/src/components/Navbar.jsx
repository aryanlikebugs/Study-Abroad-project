...
// // //         {/* Search Bar */}
// // //         <div 
// // //           className={`absolute top-16 left-0 w-full bg-black p-4 transform transition-all duration-300 ${
...
// // //         {/* Mobile Menu */}
// // //         <div 
// // //           className={`md:hidden absolute top-16 left-0 w-full bg-black transform transition-all duration-300 ${
...
// //             </button>
// //             <button
// //               className="hidden md:block px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition"
