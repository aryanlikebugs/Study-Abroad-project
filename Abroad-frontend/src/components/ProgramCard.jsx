...
// //updates after scraping data
// import React from "react";
// import { Star, Clock, MapPin, BookmarkPlus } from "lucide-react";

// // Mapping country names to country codes for flags
...
//   price,
// }) {
//   // Use Unsplash for dynamic images based on the course name
//   const courseImage = `https://source.unsplash.com/600x400/?${title},education`;
//   const fallbackImage = "https://via.placeholder.com/600x400?text=No+Image";

//   // Fetch the correct country flag or use a fallback
//   const countryCode = countryCodeMap[country] || "us"; // Default to US
...
//           onError={(e) => (e.target.src = fallbackImage)} // Ensures no blank image
//         />
//         <div className="absolute top-0 right-0 m-2">
//           <button className="p-2 bg-black/50 rounded-full hover:bg-black/70 transition-colors">
//             <BookmarkPlus className="w-5 h-5 text-white" />
...
//             src={countryFlag}
//             alt={country}
//             className="w-6 h-4 mr-2 rounded-md shadow-md"
//             onError={(e) => (e.target.src = "https://via.placeholder.com/40x30?text=🏳️")} // Prevents blank flag
//           />
    ...
    <div className="bg-white rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center text-gray-500 mb-4">
          ...
          <span className="mr-4">{location}</span>
          <Clock className="w-4 h-4 mr-1" />
          <span>Duration: N/A</span> {/* Placeholder for future duration info */}
        </div>

        {/* Scholarship and Eligibility */}
        <div className="text-gray-700 mb-4">
          <p>🎓 Scholarships: {scholarshipsOffered || "N/A"}</p>
          <p>📌 Eligibility: {eligibilityCriteriaForInternationalStudents || "Check details"}</p>
        </div>
