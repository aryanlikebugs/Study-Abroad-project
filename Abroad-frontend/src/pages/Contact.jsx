...
// export default function Contacts() {
//   const teamMembers = [
//     { name: "Aryan Gupta", roll: "Roll No: 2100001", img: "/images/aryan.jpg" },
//     { name: "Arya Tiwari", roll: "Roll No: 2100002", img: "/images/arya.jpg" },
//     { name: "Ayush Raj", roll: "Roll No: 2100003", img: "/images/ayush.jpg" },
//     { name: "Geetanshi Deewangan", roll: "Roll No: 2100004", img: "/images/geetanshi.jpg" },
//     { name: "Shreya", roll: "Roll No: 2100005", img: "/images/shreya.jpg" },
//     { name: "Rishu", roll: "Roll No: 2100006", img: "/images/rishu.jpg" },
//   ];
...
//               <div
//                 key={index}
//                 className="p-4 bg-purple-500/20 rounded-lg text-center hover:bg-purple-500/40 transition-all"
//               >
//                 <img
//                   src={member.img}
//                   alt={member.name}
...
//                   }}
//                   className="w-16 h-16 mx-auto rounded-full border-2 border-purple-400 shadow-md"
//                 />
//                 <p className="mt-2 text-sm font-medium">{member.name}</p>
//                 <p className="text-xs text-gray-300">{member.roll}</p> 
//               </div>
//             ))}
//           </div>
//         </div>
