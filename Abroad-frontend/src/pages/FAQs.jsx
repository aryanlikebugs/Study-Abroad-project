...
const faqs = [
  ...
  {
    question: "What are the career prospects after completing a CSE degree abroad?",
    answer:
          ...
          >
            ...
            <div
              className={`grid overflow-hidden transition-all duration-500 ease-in-out ${
                openIndex === index ? "grid-rows-[1fr] opacity-100 py-3 px-6" : "grid-rows-[0fr] opacity-0 px-6"
              }`}
            >
...
//         style={{
//           backgroundImage: `url('https://source.unsplash.com/1600x900/?technology,coding,abstract')`,
//         }}
//       ></div>
